...
@section('content')
<div class="bg-com-dark min-h-screen p-1 lg:p-6 rounded-[50px]">
    <div class="rounded-[40px] border border-white/10 bg-white/5 p-10 shadow-2xl backdrop-blur-[25px]">
        <div class="viewport-depth rounded-[40px] shadow-2xl overflow-hidden border border-white/5">
            ...
            <div class="container-fluid px-6 lg:px-16 py-10 max-w-[1600px] mx-auto">
                ...
                <div class="text-center mb-16 pt-6">
                    ...
                    <h1 class="text-white font-black text-5xl lg:text-6xl tracking-tighter mb-4 drop-shadow-2xl">
                        Asset <span class="text-amber-500">Import</span>
                    </h1>
                    
                    <p class="text-slate-200 font-medium text-lg max-w-2xl mx-auto leading-relaxed">
                ...
                <div class="row g-4 mb-12">
                    @php
                        $statItems = [
                            ...
                            ['label' => 'Successful Assets Imported', 'val' => number_format($stats['total_assets_imported']), 'icon' => 'check-double', 'color' => 'emerald'],
                            ['label' => 'Pending Review', 'val' => $stats['pending_imports'], 'icon' => 'clock', 'color' => 'amber'],
                            ['label' => 'Failed Imports', 'val' => $stats['failed_imports'], 'icon' => 'exclamation-triangle', 'color' => 'red'],
                        ];
                    @endphp
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="glass-panel p-6 rounded-3xl group hover:border-{{ $item['color'] }}-500/50 transition-all duration-500">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <span class="text-[10px] font-black tracking-widest text-slate-300 uppercase">{{ $item['label'] }}</span>
                            </div>
                ...
                <div class="glass-panel rounded-3xl overflow-hidden shadow-2xl">
                    <div class="p-6 border-b border-white/5 bg-white/5 flex flex-wrap justify-between items-center gap-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-slate-300 text-xs font-medium uppercase tracking-widest">Imported Assets Trail & Processing Logs</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-dark table-hover mb-0 align-middle">
                            <thead class="bg-black/20 text-slate-300 font-black text-[11px] uppercase tracking-widest">
                                <tr>
                                    <th class="px-6 py-4 border-0" style="white-space: nowrap;">Batch ID</th>
                            ...
                            <tbody class="text-slate-300 font-medium">
                                ...
                                <tr class="border-b border-white/5 hover:bg-white/5 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-slate-300 text-xs">{{ $import->entity_name }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            <span class="text-emerald-400 font-black">{{ $import->successful_imports }}</span>
                                            <span class="text-slate-400 text-xs italic">of {{ $import->total_rows }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        @php
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-[10px] text-slate-300 uppercase">{{ $import->created_at->format('M d, Y') }}</div>
                                    </td>
                                    <td class="px-6 py-4">
